...
export const STARTER_ELEMENTS: readonly StarterElementSeed[] = [
  { id: 'elem_water', name: '水', description: '澄澈流動的液體，孕育生命的起點。' },
  { id: 'elem_fire', name: '火', description: '熾熱燃燒的能量，毀滅與溫暖並存。' },
  { id: 'elem_earth', name: '土', description: '孕育萬物的堅實大地。' },
  { id: 'elem_wind', name: '風', description: '無形流動的氣流，自由不羈。' },
  { id: 'elem_thunder', name: '雷', description: '劃破天際的雷霆之力。' },
];
